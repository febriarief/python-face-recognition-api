...
class Detection:
    def __init__(self):
        caffemodel = settings.ROOT_PATH + "/src/face_detection/resources/detection_model/Widerface-RetinaFace.caffemodel"
        deploy = settings.ROOT_PATH + "/src/face_detection/resources/detection_model/deploy.prototxt"
